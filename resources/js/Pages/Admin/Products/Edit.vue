          ...
          <div class="card-style mb-30">
            <div class="card-content">
              ...
              <div class="select-style-1">
                ...
                <div class="input-style-1">
                  <label>Colors</label>
                  <input v-model="form.colors" type="text" class="form-control" @input="clearError('colors')" />
                  <div v-if="showErrors && form.errors.colors" class="text-danger text-sm mt-1">{{ form.errors.colors }}</div>
                </div>
                <div class="input-style-1">
                  <label>Sizes</label>
                  <input v-model="form.sizes" type="text" class="form-control" @input="clearError('sizes')" />
                  <div v-if="showErrors && form.errors.sizes" class="text-danger text-sm mt-1">{{ form.errors.sizes }}</div>
                </div>
                <div class="input-style-1">
                  <label>Plans</label>
                  <input v-model="form.plans" type="text" class="form-control" @input="clearError('plans')" />
...
const form = useForm({
  ...
  colors: ((props.product.meta || {}).colors || []).join(', '),
  sizes: ((props.product.meta || {}).sizes || []).join(', '),
  plans: ((props.product.meta || {}).plans || []).join(', '),
