      ...
      <div class="row align-items-center">
        <div class="col-md-6">
          <div class="title mb-30">
            ...
            <p class="text-sm text-muted">Add a new product with pricing and images.</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="text-end mb-30">
            <Link href="/admin/products" class="main-btn primary-btn-outline btn-hover">Back</Link>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-content">
              ...
              <div class="row">
                ...
                <div class="input-style-1">
                  ...
                  ></textarea>
                    <div v-if="showErrors && form.errors.description" class="text-danger text-sm mt-1">{{ form.errors.description }}</div>
                </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="input-style-1">
                  ...
                  <input v-model.number="form.price" type="number" min="0" step="0.01" class="form-control" />
                    <div v-if="showErrors && form.errors.price" class="text-danger text-sm mt-1">{{ form.errors.price }}</div>
                </div>
                </div>
                <div class="col-md-4">
                  ...
                  <select v-model="form.currency" class="form-control" @change="clearError('currency')">
                    ...
                    <div v-if="showErrors && form.errors.currency" class="text-danger text-sm mt-1">{{ form.errors.currency }}</div>
                  </div>
                </div>
                <div class="col-md-4">
                <div class="input-style-1">
                ...
                <div class="input-style-1">
                  ...
                  <input v-model.number="form.stock" type="number" min="0" class="form-control" />
                    <div v-if="showErrors && form.errors.stock" class="text-danger text-sm mt-1">{{ form.errors.stock }}</div>
                </div>
                </div>
                <div class="col-md-6">
                <div class="input-style-1">
          ...
          <div class="card-style mb-30">
            <div class="card-content">
              ...
              <div class="select-style-1">
                ...
                <div v-if="showErrors && form.errors.vendor_id" class="text-danger text-sm mt-1">{{ form.errors.vendor_id }}</div>
              </div>
              <div class="select-style-1">
                ...
                <div v-if="showErrors && form.errors.category_id" class="text-danger text-sm mt-1">{{ form.errors.category_id }}</div>
              </div>
              <div class="select-style-1">
